...
export function GithubIcon(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <defs>
        <linearGradient id="icon-github" x1="0" y1="0" x2="24" y2="24" gradientUnits="userSpaceOnUse">
          <stop offset="0%" stopColor="#f8fafc" />
          <stop offset="100%" stopColor="#cbd5e1" />
        </linearGradient>
      </defs>
      <path
        fill="url(#icon-github)"
...
export function LinkedinIcon(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <defs>
        <linearGradient id="icon-linkedin" x1="0" y1="0" x2="24" y2="24" gradientUnits="userSpaceOnUse">
          <stop offset="0%" stopColor="#60a5fa" />
          <stop offset="100%" stopColor="#0a66c2" />
        </linearGradient>
      </defs>
      <path
        fill="url(#icon-linkedin)"
