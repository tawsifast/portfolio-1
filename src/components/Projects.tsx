...
const Projects = () => {
  ...
  const projects = [
    ...
    {
      title: "Nexus Home - Property Rental & Booking Platform",
      desc: "NexusHome a property rental marketplace enabling property owners to list rentals and tenants to discover, book, and pay reservation fees online — featuring role-based dashboards, real-time booking workflows,and Stripe- powered secure payments.",
      img: "/propertyRental.png",
      repo: "https://github.com/tawsifast/Assignment-10",
      demo: "https://nexushome-phi.vercel.app",
    },
  ];
      ...
      <div ref={gridRef} className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {projects.map((project, i) => (
          <motion.div
            ...
            whileHover="hover"
            // {/* 1. Added 'flex flex-col' so we can control vertical spacing */}
            className="project-card rounded-2xl p-6 cursor-pointer shrink-0 flex flex-col h-full"
          >
            ...
            {/* 2. Added 'flex-1 flex flex-col' to allow the description area to expand */}
            <div className="space-y-3 flex-1 flex flex-col pt-6">
              <p className="text-base text-outline leading-snug">
                {project.desc}
              </p>

              {/* 3. Changed 'pt-4' to 'mt-auto pt-4' to force the links to the absolute bottom */}
